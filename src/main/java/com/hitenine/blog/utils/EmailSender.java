...
public class EmailSender {
    ...
    private EmailSender() {
        EmailSender.config(EmailSender.SMTP_QQ(false), "1751050890@qq.com", "worlglrpmseadfgc");
    }
    ...
    public static void sendRegisterVerifyCode(String code, String address) throws Exception {
        EmailSender.subject("阳关沙滩博客系统注册验证码")
                .from("阳光沙滩博客系统")
                .text("验证码 " + code + "，有效期10分钟。若非本人操作，请忽略此邮件。")
                .to(address)
                .send();
    }
}
